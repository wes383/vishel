                    ...
                    <div key={key} className="group">
                        <div className={`relative rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 ${showTitlesOnPosters ? 'group-hover:-translate-y-1' : ''}`}>
                            ...
                            >
                                ...
                                {!showTitlesOnPosters && (
                                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all duration-100 delay-[50ms] flex items-center justify-center p-4 opacity-0 group-hover:opacity-100">
